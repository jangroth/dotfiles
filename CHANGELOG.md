...
- fix: switch auto-save trigger from InsertLeave to FocusLost/BufLeave ([#133](../../pull/133))
...
- fix: migrate pyright lsp config off dead mason-lspconfig handlers ([#129](../../pull/129))
...
- feat: add Terraform support to nvim ([#124](../../pull/124))

## [2026-07-31]

### Changed

- feat: add per-window diagnostic navigation ([#123](../../pull/123))

## [2026-07-31]

### Changed

- fix: resolve venv python for pyright LSP ([#121](../../pull/121))
...
- Add network speed to tmux status bar ([#115](../../pull/115))
...
- feat(nvim): split config into modules, add yaml formatting, git blame ([#109](../../pull/109))

## [2026-07-07]

### Changed

- housekeeping ([#106](../../pull/106))
...
- feat: expand starship config with Nord theme and update prompt symbols ([#105](../../pull/105))

## [2026-07-06]

### Changed

- Fail fast in lint.sh when required tools are missing ([#103](../../pull/103))
...
- Expand ghostty help page with window management and shortcuts ([#98](../../pull/98))

## [2026-05-24]

### Changed

- Add CHANGELOG.md with backfill and auto-update workflow ([#96](../../pull/96))
